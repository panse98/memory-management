...
namespace memory_management_project
{
    class Program
    {
        ...
        public class Management
        {
            ...
            public int startingofmemory = 0;
            public List<Process> inputprocesses = new List<Process>(); //I have no idea why static is needed
            public List<Hole> inputholes = new List<Hole>();
            public List<Process> pendingprocess = new List<Process>();
            public List<FinalTable> finalOutput = new List<FinalTable>();
